-- =============================================================================
-- AutomateIQ Platform — database update 0005 (Website Agent + AI Assistant)
-- Run this ONCE in the Supabase SQL Editor, same as manual_setup.sql was.
-- Idempotent — safe to re-run. Requires manual_setup.sql to have been run.
-- =============================================================================
