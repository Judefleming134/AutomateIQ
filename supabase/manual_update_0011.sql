-- =============================================================================
-- AutomateIQ manual update 0011 — Growth Engine (internal sales workspace)
--
-- Run in the Supabase SQL Editor (after 0010). Fully idempotent — safe to
-- re-run. Identical to supabase/migrations/0011_growth_engine.sql.
-- =============================================================================
