...
async function runJarvisAction(
  ...
  switch (a.type) {
    ...
    case "queue_email": {
      ...
      return `✓ ${prospect.company}: queued for the morning send (~${morningSendLabel()})`;
    }
    case "add_note": {
