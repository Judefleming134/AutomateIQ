...
const DATED_REMINDERS: Record<string, string[]> = {
  ...
  "2026-07-27": [
    ...
    "① LUNCHTIME (12–1, it's really a 10-min job): paste supabase/manual_update_tradeos_finance.sql into the Supabase SQL Editor — automateiq.ie/tradeos + /finance go fully live. Then 2 min in /finance: set your bank balance, scan one supplier invoice. Log any morning calls you missed while you're there.",
