...
const DATED_REMINDERS: Record<string, string[]> = {
  ...
  "2026-07-12": [
    "SUNDAY — MORE SENDING + AIM THE WEEK. Same drill as yesterday, plus setup:",
    "① Check the 8am sends + any replies — answer replies first.",
    "② Keep sending DMs from the researched list (another 15–20) and queue Monday's 8am emails before bed.",
    "③ Finalise MONDAY'S DIAL LIST: Prospects → has phone → sort by Lead score → eyeball the top 30. Those are Monday's calls.",
    "④ Castleknock DEMO DRY-RUN: rehearse the Zoom — agent off your phone, talk track, pricing, order form. Time it tight.",
    "⑤ Early night — Monday you dial sharp.",
  ],
  "2026-07-13": [
