 ...
 */
const ANGLE_TERMS: { angle: string; terms: string[]; weight: number }[] = [
  ...
  { angle: "Speed-to-Lead", terms: ["lead response", "response time", "speed to lead", "enquiries", "inquiries", "sales follow-up"], weight: 3 },
  { angle: "Review Agent", terms: ["review", "reputation", "google business", "star rating", "customer feedback"], weight: 2 },
  { angle: "Instant Quote Agent", terms: ["quote", "quoting", "estimate", "pricing tool"], weight: 2 },
  ...
  { angle: "AI Logistics", terms: ["logistics", "delivery", "fleet", "route", "supply chain", "haulage"], weight: 2 },
  { angle: "Health, Safety & Compliance", terms: ["compliance", "regulation", "health and safety", "hse", "audit", "gdpr", "ai act"], weight: 3 },
  { angle: "Website & Lead Capture", terms: ["website", "seo", "search", "google ranking", "web traffic"], weight: 2 },
